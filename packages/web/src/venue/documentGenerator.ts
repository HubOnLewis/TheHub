...
import { buildClientDetailsDocHtml, formatCurrency, venueStageLabel, type ClientDetails } from '@hub-crm/shared';
...
export function buildBeoHtml(model: EventDetailViewModel): string {
  ...
  <table>
    ...
    <tbody>
      <tr><td>Confirm final guest count</td><td>${esc(model.owner)}</td><td>☐</td></tr>
      <tr><td>Room / space setup diagram</td><td>Ops</td><td>☐</td></tr>
      <tr><td>Access / Kisi codes</td><td>Ops</td><td>☐</td></tr>
      <tr><td>F&B / catering confirmed</td><td>Coordinator</td><td>☐</td></tr>
      <tr><td>AV / tech needs</td><td>Ops</td><td>☐</td></tr>
      <tr><td>Final balance collected</td><td>Coordinator</td><td>☐</td></tr>
    </tbody>
  </table>
